	  ...
	  npartial =0
          if(ntype_atom_No(nt1) .ne. 0) then ! the atom No of type nt1 is not 0
             do nt2=1,ntot_type
	          ...
	          write(219,*)'ave partial CN of ',elem_name(nt1), "-" ,elem_name(nt2),": ", ave_partial_CN(nt1,nt2)
                   if(npair_No(nt1,nt2) .ne. 0)then
                          
                     temp_aved=ave_bondL(nt1,nt2)/dble(npair_No(nt1,nt2))
                     write(219,*)'ave-bond length of ',elem_name(nt1), "-" ,elem_name(nt2),": ", temp_aved
                   endif
	     ...
	     ave_CN(nt1) =dble(npartial)/dble(ntype_atom_No(nt1))
           write(219,*)"total CN of ",elem_name(nt1),": ", ave_CN(nt1)
	   endif
      enddo
...
!....... writing CSRO
      write(219,*)" "
      write(219,*)"Printing CSRO for each element pair"
